            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('team_img'); ?>" alt="<?php the_field('team_img'); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            <?php the_field('descr_1'); ?>       
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('img_1'); ?>" alt="<?php the_field('img_1'); ?>">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('img_2'); ?>" alt="<?php the_field('img_1'); ?>">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="aboutus__text">
                            <?php the_field('descr_3'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('img_3'); ?>" alt="<?php the_field('img_1'); ?>">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class = "contacts__feed">
                            <?php echo do_shortcode( '[contact-form-7 id="145" title="Контактная форма 1"]' ); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
...
<!-- <?php
    ...
    do_action( 'my_hook', 'dear customer', 'John' );
